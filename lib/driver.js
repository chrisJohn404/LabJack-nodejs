...
exports.ljmDriver = function() {
    ...
    **/
    ...
    var prepareOpenAll = function(me, deviceType, connectionType) {
        ...
        // TODO: Move this somewhere more canonical
        var SIZEOF_INT = 4;
        var LJM_LIST_ALL_SIZE = 128;
        ...
        me.aHandles = new Buffer(SIZEOF_INT * LJM_LIST_ALL_SIZE);
        me.aHandles.fill(0);
        me.numErrors = new ref.alloc('int', 0);
        me.aErrors = new Buffer(SIZEOF_INT * LJM_LIST_ALL_SIZE);
        me.aErrors.fill(0);
    ...
    var extractOpenAllResults = function(me) {
        ...
        for(var i = 0; i < numDevices; i++) {
            results.push({
                ...
                handle: me.aHandles.readInt32LE(SIZEOF_INT)
            });
        }
        return results;
    }
